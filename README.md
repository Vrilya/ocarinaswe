...
Jag har även ändrat tillbaka till Nintendo 64-färger för knappar i GameCube-ROM:arna och återinfört Nintendo 64-bootlogon. För PAL-ROM:arna från GameCube, som normalt körs i MPAL (60 Hz, 3.58 MHz färgburst), har jag bytt ut spelets videointerface mot standard-PAL (4.43 MHz) så att spelet visas korrekt på europeiska Nintendo 64.
