...
Jag har även ändrat tillbaka till Nintendo 64-färger för knappar i GameCube-ROM:arna och återinfört Nintendo 64-bootlogon. För GameCube-ROM:arna man hittar på PAL-bonusskivor har jag bytt ut spelets videointerface mot standard-PAL så att spelet visas korrekt på europeiska Nintendo 64.
