...
En del av arbetet har bestått i att själv kartlägga PAL-ROM:en och dokumentera var alla bitmapbilder jag behövde fanns. Jag har byggt egna verktyg från grunden i Python, C99 och C#, bland annat för yaz0-komprimering/dekomprimering, extrahering/konvertering av bitmappar samt en editor för redigering av spelets text.
